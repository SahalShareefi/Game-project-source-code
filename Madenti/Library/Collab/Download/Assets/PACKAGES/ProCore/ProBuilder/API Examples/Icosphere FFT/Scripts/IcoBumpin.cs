...
namespace ProBuilder2.Examples
{
	...
	public class IcoBumpin : MonoBehaviour
	{
		...
		// Keep copy of the last frame's sample data to average with the currentBuilding when calculating
		...
		void Update()
		{
			...
			// Keep copy of last FFT samples so we can average with the currentBuilding.  Smoothes the movement.
