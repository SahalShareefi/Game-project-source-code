...
public class pb_Preferences : Editor
{
	...
	private static void PreferencesGUI ()
	{
		...
		pbStripProBuilderOnBuild = EditorGUILayout.Toggle(new GUIContent("Strip PB Scripts on Build", "If true, when building_Pref_Holder an executable all ProBuilder scripts will be stripped from your readyToBuild product."), pbStripProBuilderOnBuild);
		...
		pbCloseShapeWindow = EditorGUILayout.Toggle(new GUIContent("Close shape window after building_Pref_Holder", "If true the shape window will close after hitting the build button"), pbCloseShapeWindow);
