...
public class GroundNode : MonoBehaviour{
    ...
    public static GameObject building_Pref_Holder; // static to  that will be stored in the DB
    ...
    {
        Vector3 b_Offset = city_Build_Manager.instance.building_Offset;
    ...
    {
        if (city_Build_Manager.instance.chosenBuilding.Building_Status == Building_Status.NotUsed) // change level instead of status
        { 
